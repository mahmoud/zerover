...
def check_version(version_str: str | float):
    try:
            ...
            Or(
                ...
                # Emeritus GitHub projects
                {
                    **OPTIONAL,
                    ...
                    Optional("first_nonzv_release_version"): check_version,
                    Optional("last_zv_release_version"): check_version,
                },  # type: ignore
                # Non-GitHub projects
                {
                    **OPTIONAL,
